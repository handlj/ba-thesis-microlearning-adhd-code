export const copy = {
  ...
  preQuiz: {
    ...
    dialog: {
      ...
      content:
        'Dieses Quiz ist ein **Vortest** um Ihre aktuellen Kenntnisse zu erfassen. Beachten Sie daher folgende Punkte:\n\n - Es ist **völlig normal**, wenn Sie viele Fragen nicht korrekt beantworten können.\n - Lassen Sie sich in diesem Fall **nicht zu lange aufhalten** und wählen Sie, was für Sie am meisten Sinn ergibt.\n - Wenn Sie nicht raten wollen, können Sie auch **„Ich weiß es nicht“** auswählen.',
    },
  },
  controlGroup: {
    heading: {
