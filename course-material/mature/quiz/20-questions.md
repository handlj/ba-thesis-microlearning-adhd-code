# 20 Microlearning Questions

>**Corpus:** 20 Questions   
>**Format:** Single Choice   
>**Mastery Threshold:** 4 out of 5 correct (80%)
...
- **Question:** Betrachten Sie die Variable `string = "abcdef"`. Welche der folgenden Aussagen ist korrekt?

| | Antwortalternative | |
|---|---|---|
| a | `string[0]` hat den Wert `abcdef` | |
| b | `string[1:3]` hat den Wert `abc` | |
| c | `string[0:6]` hat den Wert `abcdef` | Correct |
| d | `string[5]` hat den Wert `e` | |
...
- **Question:** Betrachten Sie die folgenden beiden Code-Auszüge. Welche der folgenden Aussagen ist korrekt?
...
| | Antwortalternative | |
|---|---|---|
| a | Auszug A zeigt immer die gleiche Ausgabe wie Auszug B. | |
| b | Für `x = 100` zeigen beide Auszüge die gleiche Ausgabe. | |
| c | Für `x = 30` zeigen beide Auszüge die gleiche Ausgabe. | Correct |
| d | Auszug A zeigt immer eine andere Ausgabe wie Auszug B. | |
...
- **Question:** Welche der folgenden Paare von Schlüsselwörtern steuern den Ablauf einer Schleife (Schleife abbrechen oder zur nächsten Iteration springen)?

| | Antwortalternative | |
|---|---|---|
| a | `break` und `for` | |
| b | `break` und `continue` | Correct |
| c | `continue` und `while` | |
| d | `for` und `while` | |
...
- **Question:** Betrachten Sie erneut die Funktion which_dog_is_it. Welchen Fehler erhält man bei folgendem Funktionsaufruf?
...
| b | *(Code-Block)* `TypeError: which_dog_is_it() missing 1 required positional argument: 'age'` | |
| c | *(Code-Block)* `TypeError: which_dog_is_it() missing 1 required positional argument: 'ownername'` | Correct |
| d | Kein Fehler in der Ausführung, aber: "Logischer Fehler" | |

---

### D5

- **ID:** `d5` · **Timestamp:** 127 s (02:07)
...
|-------|------------------------------|
| A - Variablen & Datentypen | a1: 42 · a2: 137 · a3: 99 · a4: 202 · a5: 157 |
| B - Bedingungen | b1: 102 · b2: 3 · b3: 205 · b4: 205 · b5: 102 |
| C - Schleifen | c1: 265 · c2: 89 · c3: 226 · c4: 226 · c5: 133 |
| D - Funktionen | d1: 58 · d2: 127 · d3: 220 · d4: 270 · d5: 127 |
