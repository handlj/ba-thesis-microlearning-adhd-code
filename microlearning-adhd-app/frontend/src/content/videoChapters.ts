...
export const experimentalVideoChapters: Record<string, readonly VideoChapter[]> = {
  ...
  'experimental-video-2': [
    ...
    { startSeconds: 158, title: 'Syntax Beispiel' },
  ],
  'experimental-video-3': [
    ...
    { startSeconds: 175, title: 'While-Loops: Endlosschleifen' },
  ],
  'experimental-video-4': [
    { startSeconds: 0, title: 'Funktionen: Grundkonzept' },
    { startSeconds: 58, title: 'Beispiele' },
    { startSeconds: 91, title: 'Funktionen: Definition' },
    { startSeconds: 143, title: 'Weitere Beispiele' },
    { startSeconds: 184, title: 'Valide Funktionsaufrufe' },
  ],
}
